// hash page
const $cartUseGuide = document.querySelector('.page-cart-use-guide');
...
const $selectWrapListWrapBox = document.querySelector('#select-wrap .list-wrap-box');
const $selectWrapListWrapBoxListWrap = document.querySelector('#select-wrap .list-wrap-box .list-wrap');
const $selectWrapListWrapBoxListWrapLists = document.querySelectorAll('#select-wrap .list-wrap-box .list-wrap .list');


window.addEventListener('load', () => {
  // // hash -------------------------
  const hash = location.hash;
  const $prevLink1 = document.querySelector('#prev-link1');

  if($cartUseGuide) {
    if(hash === '#sub-1') {
      $prevLink1.href = './sub-1.html'

    } else if(hash === '#sub-1-3') {
      $prevLink1.href = './sub-1-3.html'

    } else if(hash === '#setting') {
      $prevLink1.href = './setting.html'
  ...
  if($sub1) {
    if(hash === '#tutorial') {
      ...
      document.querySelector('#popup-wrap').classList.add('on');
      document.querySelector('#tutorial-popup').classList.add('on');
    }
  }
