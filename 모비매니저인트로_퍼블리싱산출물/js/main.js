...
function page8Keep(pageCount) {
  if(pageCount === 8) {
    if(!$page8.classList.contains('keep')) $page8.classList.add('keep');
  } else {
    if($page8.classList.contains('keep')) $page8.classList.remove('keep');
  }
}