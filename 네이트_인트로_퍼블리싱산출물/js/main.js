import { fullPageEffect, fullResize, topBtnFlag, menuFlag, navFlag, specificFlag, moveBtnFlag, pageCount, pageLength, $menus, $navWrap, $navs, $topBtn, $moveBtns, pageWrapTime } from './fullPage.js';
...
// header type change
function headerTypeChange(pageCount) {
  if (pageCount <= 0) {
...
window.addEventListener('click', (e) => {
  if (!e.target.closest('#select-box1') && $selectBox1.classList.contains('on')) {
